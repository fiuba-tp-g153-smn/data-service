...
async def get_radar_variable(
    variable_id: str = PathParam(..., description="Variable identifier (e.g., dbzh, zdr, rhohv, kdp)")
):
    """
...
async def get_radar_station_tilesets(
    ...
    station_id: str = PathParam(..., description="Station identifier (e.g., rma3, rma4, rma9)")
):
    """
...
async def get_radar_tile(
    ...
    tileset_id: str = PathParam(..., description="Tileset identifier (timestamp, e.g., 20251230T151917Z)"),
