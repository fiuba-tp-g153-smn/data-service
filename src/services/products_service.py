...
class ProductsService:
    ...
    def get_radar_station_tilesets(
        self, variable_id: str, station_id: str
    ) -> Optional[dict]:
    ...
    def get_radar_tile_path(
        ...
        # Path: data/output_radar/DBZH/RMA3_DBZH_20251230T151917Z_elev0/tiles/z/x/y.webp
