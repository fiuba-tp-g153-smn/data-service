...
class RadarService(BaseProductService):
    ...
    def __init__(self):
        ...
        has_available = any(var.get("available", False) for var in self.RADAR_VARIABLES.values())
        
        # Register radar in the global registry
        self.register_product("radar", {
            "name": "Red de Radares",
    ...
    def get_tile_path(self, variable_id: str, station_id: str, elevation_id: str,
